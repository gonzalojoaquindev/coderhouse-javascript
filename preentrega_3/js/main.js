...
/* //Crear array inicial de transacciones en local storage
localStorage.setItem("transactions", JSON.stringify([])) */

/* 
Transaction.addTransaction(100, "ingreso", "salario", "cuenta_corriente", "prueba1")
Transaction.addTransaction(200, "gasto", "trabajo", "cuenta_rut", "prueba2") */
...
export function createTransactionCard(transaction) {
    ...
    console.log(date); // Muestra un objeto Date válido
    ...
    card.innerHTML = `
        ...
        <div class="transaction-details">
            ...
            <p><strong>Fecha:</strong> ${new Intl.DateTimeFormat('es-ES', opciones).format(date)}</p>
        </div>
    `;
...
//Pintar las transacciones existentes
...
export const updateTransactionRender = () => {

    for (let transaction of transactions) {
        console.log('actualizando', transaction)
        createTransactionCard(transaction)
    }
